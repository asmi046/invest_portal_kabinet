...
use App\Http\Requests\LandLeaseApplication\LandLeaseApplicationDraftRequest;

class LandLeaseApplicationController extends Controller
{
    protected $model = LandLeaseApplication::class;
    protected $draftRequest = LandLeaseApplicationDraftRequest::class;
    protected $signRequest = LandLeaseApplicationSignRequest::class;
    protected string $viewFolder = 'land_lease_application';
