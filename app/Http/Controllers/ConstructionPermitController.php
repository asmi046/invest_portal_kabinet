...
use App\Http\Requests\ConstructionPermit\ConstructionPermitSignRequest;
use App\Http\Requests\ConstructionPermit\ConstructionPermitDraftRequest;

class ConstructionPermitController extends Controller
{
    protected $model = ConstructionPermit::class;
    protected $draftRequest = ConstructionPermitDraftRequest::class;
    protected $signRequest = ConstructionPermitSignRequest::class;
    protected string $viewFolder = 'construction_permit';
