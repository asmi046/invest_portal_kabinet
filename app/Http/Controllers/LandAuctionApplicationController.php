...
use App\Http\Requests\LandAuctionApplication\LandAuctionApplicationSignRequest;
use App\Http\Requests\LandAuctionApplication\LandAuctionApplicationDraftRequest;

class LandAuctionApplicationController extends Controller
{
    protected $model = LandAuctionApplication::class;
    protected $draftRequest = LandAuctionApplicationDraftRequest::class;
    protected $signRequest = LandAuctionApplicationSignRequest::class;
    protected string $viewFolder = 'land_auction_application';
