...
use App\Http\Requests\Tc\TcSignRequest;
use App\Http\Requests\Tc\TcDraftRequest;

class TechnicalConnectNewController extends Controller
{
    protected $model = TechnicalConnects::class;
    protected $draftRequest = TcDraftRequest::class;
    protected $signRequest = TcSignRequest::class;
    protected string $viewFolder = 'technical_connects';
