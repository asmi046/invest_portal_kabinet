...
use App\Http\Requests\HeatConnection\HeatConnectionSignRequest;
use App\Http\Requests\HeatConnection\HeatConnectionDraftRequest;

class HeatConnectionController extends Controller
{
    protected $model = HeatConnection::class;
    protected $draftRequest = HeatConnectionDraftRequest::class;
    protected $signRequest = HeatConnectionSignRequest::class;
    protected string $viewFolder = 'heat_connection';
