...
use App\Http\Requests\Support\SupportSignRequest;
use App\Http\Requests\Support\SupportDraftRequest;

class GossSupportController extends Controller
{
    protected $model = Support::class;
    protected $draftRequest = SupportDraftRequest::class;
    protected $signRequest = SupportSignRequest::class;
    protected string $viewFolder = 'support';
