...
class HeatConnectionDraftRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'applicant_address_ur' => ['nullable', 'string', 'max:256'],
            'applicant_address_post' => ['nullable', 'string', 'max:256'],
            ...
            'applicant_inn_kpp' => ['nullable', 'string', 'max:256', 'regex:/^\d+$/'],
            ...
            'reliability_category' => ['nullable', 'string', 'max:50'],
