...
>
    ...
    :list="[
        ...
        'Заключение уполномоченного на осуществление федерального государственного экологического надзора федерального органа исполнительной власти']" :selected="$item->doc_name ?? old('doc_name')" />
    ...
    :list="[
        ...
        'Направить на бумажном носителе на почтовый адрес']" :selected="$item->send_result_type ?? old('send_result_type')" />
