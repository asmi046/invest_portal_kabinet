...
>
    ...
    <div class="columns-box columns-box--two-col">
        ...
        <x-form.input name="applicant_ogrn" label="ОГРН / ОГРНИП заявителя" :required="false" value="{{ $item->applicant_ogrn ?? old('applicant_ogrn') }}" />
    ...
    <div class="columns-box columns-box--two-col">
        ...
        <x-form.input name="lease_term" label="Срок аренды земельного участка" :required="false" value="{{ $item->lease_term ?? old('lease_term') }}" />
    ...
    <x-form.textarea name="basis" label="Основание предоставления земельного участка без проведения торгов" :required="false" value="{{ $item->basis ?? old('basis') }}" />
