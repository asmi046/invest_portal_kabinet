            ...
            <div class="btn-link-box columns-box">
                <div class="btn-link goskey_banner">
                    ...
                    <div class="text_wrappe">
                        ...
                        <p><a href="{{ route('ukep_info') }}">Как физическим лицам подписать документ с помощью Госключа?</a></p>
                        <p><a href="{{ route('ukep_info_ul') }}">Как юридическим лицам подписать документ с помощью Госключа?</a></p>
                        <p>В нашем личном кабинете Вы можете подписать все запросы при помощи мобильного приложения Госключ.</p>
