        ...
        <div class="inner">
            ...
            <div class="columns-box columns-box--two-col">
                <div class="file_info">
                    ...
                    <br>
                    Тип документа: <strong>{{ $document_type->name  }}</strong>
                </div>
                <div class="sert_list">

                    <form id="cert_form" action="">
                        <input type="hidden" id="file_lnk" name="file_lnk" value="{{ route('sign_download',['filename' => $file->storage_patch."/".$file->file]) }}">
                        <input type="hidden" id="signe_id" name="signe_id" value="{{ $file->id }}">
                        <input type="hidden" id="return_lnk" name="return_lnk" value="{{ $document_type->index_url."/edit/". $file->document_id }}">
